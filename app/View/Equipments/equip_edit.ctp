...
<?php echo $this->Form->create('Equipment', array('div'=>false, 'inputDefaults' => array('label' => false,'div' => false))); ?>
	<table>
		<tr>
			<td>儀器名稱：</td><td><?php echo $this->Form->text('equip_name', array('size'=>2));?>(最多30碼英文字母或數字)</td>
		</tr>
		<tr>
			<td>儀器編號：</td>
			<td>
		...
		<tr>
			<td>下次校正日期：</td><td><?php echo $this->Form->input('maintain_time');?></td>
		</tr>
		<tr>
		...
		<tr>
			<td>使用狀態：</td><td><?php echo $this->Form->input('status');?></td>
		</tr>
		<tr>
