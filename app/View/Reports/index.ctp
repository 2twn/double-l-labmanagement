...
<div id="tabs">
	...
	<li><a href="#equip_today_content">本日儀器預約列表</a></li>
	<li><a href="#equip_tomorrow_content">次日儀器預約列表</a></li>
	...
	<div id="equip_today_content"></div>
	<div id="equip_tomorrow_content"></div>
